  ...
  return (
    <footer className="bg-black text-white pt-16 pb-6 font-sans">
      <div className="container mx-auto px-4">
        {/* Top Footer Content */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-0 mb-12 border-b border-gray-800 pb-12">
          
          {/* Brand Column (Left) */}
          <div className="col-span-1 md:pr-12 md:border-r border-white/20 flex flex-col items-start">
            {/* Logo */}
            ...
            <div className="flex gap-4">
              ...
              <a 
                ...
                className="bg-white/10 p-2.5 rounded-full hover:bg-[#25D366] hover:text-white transition-colors focus:outline-none focus:ring-2 focus:ring-[#25D366]"
          ...
          <div className="col-span-1 md:px-12 md:border-r border-white/20 flex flex-col items-start">
          ...
          <div className="col-span-1 md:pl-12 flex flex-col items-start">
